...
class Course(models.Model):
    creator = models.ForeignKey(AchieveUser, on_delete=models.SET_NULL, null=True, blank=True)
...
class Module(models.Model):
    ...
    module_creator=models.ForeignKey(AchieveUser,on_delete=models.SET_NULL, null=True)
    ...
    lesson_pdf=models.FileField(upload_to='module_lesson_pdfs/', blank=True, null=True)
...
class Flashcard(models.Model):
    lesson=models.ForeignKey(Module, on_delete=models.CASCADE, related_name='flashcards')
    flashcard_question=models.TextField()
    flashcard_answer=models.TextField()
    flashcard_image=models.ImageField(upload_to="flashcard_images/", blank=True, null=True)   
...
class QuizAttempt(models.Model):
   ...
   taken_by=models.ForeignKey(AchieveUser, on_delete=models.CASCADE, related_name="taken_by")
